...
import com.chiem.missilemod.init.ModItemGroups;
...
@Mod.EventBusSubscriber(modid = MissileMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public final class ModEventSubscriber {

    private static final Logger LOGGER = LogManager.getLogger(MissileMod.MODID + " Mod Event Subscriber");
